...
public class LibParam_iOS extends LibParamBase{
	public LibParam_iOS(ClParamBase cl_param,ClToolsEnvBase tools_env){
		lib_ext="a";
	...
	private static String[] converLibParam(LibParamBase lib_param,ClToolsEnvBase tools_env){
		...
		if(ClTargetType_iOS.isX86(lib_param.target_type)){
