...
public class LinkParam_iOS extends LinkParamBase{
	public LinkParam_iOS(ClParamBase cl_param,ClToolsEnvBase tools_env){
	...
	private static String[] converLinkParam(LinkParamBase link_param,ClToolsEnvBase tools_env){
		...
		if(ClTargetType_iOS.isX86(link_param.target_type)){
