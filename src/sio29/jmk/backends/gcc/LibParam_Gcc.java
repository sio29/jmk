...
public class LibParam_Gcc extends LibParamBase{
	public LibParam_Gcc(ClParamBase cl_param,ClToolsEnvBase tools_env){
		lib_ext="a";
	...
	private static String[] converLibParam(LibParamBase lib_param,ClToolsEnvBase tools_env){
		...
		if(ClTargetType_Gcc.isX86(lib_param.target_type)){
