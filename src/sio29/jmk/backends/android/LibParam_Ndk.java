...
public class LibParam_Ndk extends LibParamBase{
	public LibParam_Ndk(ClParamBase cl_param,ClToolsEnvBase tools_env){
		lib_ext="a";
	...
	private static String[] converLibParam(LibParamBase lib_param,ClToolsEnvBase tools_env){
		...
		if(ClTargetType_Ndk.isX86(lib_param.target_type)){
