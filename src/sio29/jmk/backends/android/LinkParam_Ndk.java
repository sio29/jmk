...
public class LinkParam_Ndk extends LinkParamBase{
	public LinkParam_Ndk(ClParamBase cl_param,ClToolsEnvBase tools_env){
	...
	private static String[] converLinkParam(LinkParamBase link_param,ClToolsEnvBase tools_env){
		...
		if(ClTargetType_Ndk.isX86(link_param.target_type)){
