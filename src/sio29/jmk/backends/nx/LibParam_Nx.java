...
public class LibParam_Nx extends LibParamBase{
	public LibParam_Nx(ClParamBase cl_param,ClToolsEnvBase tools_env){
		lib_ext="a";
	...
	private static String[] converLibParam(LibParamBase lib_param,ClToolsEnvBase tools_env){
		...
		if(ClTargetType_Nx.isX86(lib_param.target_type)){
