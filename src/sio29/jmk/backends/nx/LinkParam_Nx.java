...
public class LinkParam_Nx extends LinkParamBase{
	public LinkParam_Nx(ClParamBase cl_param,ClToolsEnvBase tools_env){
	...
	private static String[] converLinkParam(LinkParamBase link_param,ClToolsEnvBase tools_env){
		...
		if(ClTargetType_Nx.isX86(link_param.target_type)){
