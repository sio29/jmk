...
//System.out.println("JmkBashExec.execShell");
		ShellExecReturn retdata=new ShellExecReturn();
		String text=null;
		try {
			ProcessBuilder pb=new ProcessBuilder(args);
			if(param!=null && param.current_dir!=null){
//System.out.println("param.current_dir:"+param.current_dir);
...
//System.out.println("retdata.text="+retdata.text );
